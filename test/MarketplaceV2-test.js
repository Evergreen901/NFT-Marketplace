...
describe("Marketplace contract", () => {
  beforeEach(async () => {
    ...
    MarketplaceContract = await ethers.getContractFactory("MarketplaceV2");
  ...
  describe("Deployment", () => {
    ...
    it("Should initialize auction sequence to 0", async () => {
  ...
  describe("Transactions - Create Auction", () => {
    ...
    describe("Create Auction - Failure", () => {
      ...
      it("Should reject Auction because owner of the NFT hasn't approved ownership transfer", async () => {
        let endAuction = Math.floor(Date.now() / 1000) + 10000;
        await expect(
          Marketplace.createAuction(
            NFTCollection.address,
  ...
  describe("Transactions - Place new Bid on auction", () => {
    ...
    describe("Place new Bid on an auction - Failure", () => {
      ...
      it("Should reject new Bid because new bider has not enough balances", async () => {
    ...
    describe("Place new Bid on an auction - Success", () => {
      ...
      it("Current bid owner must be refunded after a new successful bid is placed", async () => {
        // Allow marketplace contract to transfer token of USER2
...
async function claimFunctionSetUp(
  ...
  //mint new NFT
  await NFTCollection.connect(auctionCreator).mintNFT(
    "Test NFT",
    "test.uri.domain.io"
  );
